...
const {saveBusiness, createWorkflow, view, saveRazorpayKeys} = require('./businessController')
...
const businessRouting = (app) => {
    ...
    router.post('/save-razorpay-keys', saveRazorpayKeys);
    router.put('/save-razorpay-keys', saveRazorpayKeys);
